...
const EXTENSION_DOWNLOAD_URL = '/downloads/clipit-extension-1.5.3.zip';
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-5">
          ...
          <motion.div
            ...
            className="relative max-h-[calc(100dvh-2.5rem)] w-full max-w-lg overflow-y-auto rounded-2xl border border-subtle bg-app p-6 shadow-lg sm:p-7"
          >
            <Button type="button" onClick={onClose} variant="ghost" size="icon" aria-label="Close" className="absolute right-4 top-4 h-8 w-8 text-muted">
