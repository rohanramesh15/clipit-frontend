    ...
    return (
      <div className="mx-auto flex max-w-md flex-col items-center gap-5 px-5 text-center sm:px-8">
        <div className="flex h-20 w-20 items-center justify-center rounded-full bg-sand-soft">
          <Sparkles className="h-10 w-10 text-sand-deep" aria-hidden="true" />
        </div>
        <div>
        ...
        <div className="mt-2 flex flex-col items-center gap-3">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="rounded-xl border border-sand-mid/60 bg-sand-tint px-5 py-2.5 text-body-sm font-semibold text-sand-deep transition-colors duration-150 ease-swift hover:bg-sand-soft"
            >
              I'm done for today
            </button>
            <button
              onClick={onKeepReviewing}
              className="rounded-xl bg-sand-ink px-5 py-2.5 text-body-sm font-semibold text-[#ffffff] transition-colors duration-150 ease-swift hover:bg-sand-deep"
            >
              Keep reviewing
            </button>
          </div>
    ...
    return (
      <div className="mx-auto flex max-w-md flex-col items-center gap-4 px-5 text-center sm:px-8">
        <div className="flex h-16 w-16 items-center justify-center rounded-full bg-sand-soft">
          <Trophy className="h-8 w-8 text-sand-deep" aria-hidden="true" />
        </div>
        ...
        <button
          onClick={onBackToDecks}
          className="mt-4 rounded-xl bg-sand-ink px-6 py-3 text-body font-semibold text-[#ffffff] transition-colors duration-150 ease-swift hover:bg-sand-deep"
        >
          Back to decks
        </button>
      </div>
    ...
    <div className="mx-auto flex max-w-md flex-col items-center px-5 text-center sm:px-8">
      ...
      <div className="mt-12 flex flex-col gap-3 sm:flex-row">
        <button
          ...
          className="rounded-xl bg-sand-ink px-6 py-3 text-body font-semibold text-[#ffffff] transition-colors duration-150 ease-swift hover:bg-sand-deep"
        >
          Review all cards again
        </button>
        <button
          onClick={onBackToDecks}
          className="rounded-xl border border-sand-mid/60 bg-sand-tint px-6 py-3 text-body font-semibold text-sand-deep transition-colors duration-150 ease-swift hover:bg-sand-soft"
        >
          Back to decks
        </button>
      </div>
