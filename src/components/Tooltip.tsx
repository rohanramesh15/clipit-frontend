...
/** Matches the app's help tooltips: ink fill, app-coloured text, rounded-lg. */
  ...
  return (
    <span className="group/tip relative inline-flex">
      ...
      <span
        ...
        className={`pointer-events-none invisible absolute left-1/2 z-40 -translate-x-1/2 whitespace-nowrap rounded-lg bg-ink px-2.5 py-1.5 text-meta font-medium text-app opacity-0 shadow-xl transition-opacity duration-150 ease-swift group-hover/tip:visible group-hover/tip:opacity-100 group-[:has(:focus-visible)]/tip:visible group-[:has(:focus-visible)]/tip:opacity-100 ${position}`}
      >
        {label}
      </span>
    </span>
